...
setInterval(function() {
  ...
  <form action="/action_page.php" class="form-container">
    ...
    <button type="submit" class="btn">Wyślij</button>
					...
					<div id="glowny">
					<center>
				<a href="slownik.php">	<h2>Słownik</h2> </a> <br>
				<a href="E1.php"><h2>Etap I </h2> </a><br>
				<a href="E2.php"><h2>Etap II </h2> </a><br>
				<a href="E3.php"><h2>Etap III</h2>  </a><br>
				<a href="E4.php"><h2>Etap IV</h2>  </a><br>
		</center>
