...
setInterval(function() {
  ...
  <form action="/action_page.php" class="form-container">
    ...
    <button type="submit" class="btn">Wyślij</button>
				...
				<div class="obrazy">
				<a href="kurs.php" class="zdj1" style="text-decoration: none" >    	Kurs snowboard	</a>
					</div>
					<br>
					<br>
					<br>
					<div class="obrazy">
					<a href="sprzet.php" class="zdj2" style="text-decoration: none" >    	Sprzęt	</a>
						</div>
						<br>
						<br>
						<br>
						<div class="obrazy">
					<a href="pogoda.php" class="zdj3" style="text-decoration: none" >    	Pogoda	</a>
						</div>
						</div>
