...
setInterval(function() {
  ...
  <form action="/action_page.php" class="form-container">
    ...
    <button type="submit" class="btn">Wyślij</button>
					...
					<div id="glowny">
					<center>
					<b><h2>Wykorzystane linki do zrobienia projektu:</h2></b>
					<br>
					<h3>
					<a href="https://www.youtube.com/">Youtube </a>
					<br>
					<a href="http://www.swiatpogody.pl/skrypt-pogoda.html">Świat Pogody </a>
					<br>
					<a href="https://www.w3schools.com/html/"> W3schools</a>
					<br>
					<a href="https://supersklep.pl/poradnik-jak-dobrac-sprzet-snowboardowy">Supersklep </a>
					</h3>
					</center>							
