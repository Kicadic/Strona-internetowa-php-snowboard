...
setInterval(function() {
  ...
  <form action="/action_page.php" class="form-container">
    ...
    <button type="submit" class="btn">Wyślij</button>
					...
					Świeradów-Zdrój
<!-- widget pogoda -->
<div id="widget_f25eccd12198040c03c9a6afadcf6b16">
<span id="l_f25eccd12198040c03c9a6afadcf6b16"><a href="http://www.swiatpogody.pl/pogoda-polska/swieradow-zdroj.html">Swiat Pogody</a></span>
<script type="text/javascript">
(function() {
	var my = document.createElement("script"); my.type = "text/javascript"; my.async = true;
	my.src = "http://serwisy.swiatpogody.pl/widget/js-design.php?ville=759&format=grand-rectangle&nb_jours=5&ombre1=000000&c1=ffffff&c2=a9a9a9&c3=ffffff&c4=ffffff&c5=ffffff&police=0&t_icones=2&fond=1&masque=3&x=300&y=250&id=f25eccd12198040c03c9a6afadcf6b16";
